...
cv2.createTrackbar("WLH", "WTracking", 78, 255, nothing)
cv2.createTrackbar("WLS", "WTracking", 0, 255, nothing)
cv2.createTrackbar("WLV", "WTracking", 168, 255, nothing)

cv2.createTrackbar("WUH", "WTracking", 132, 255, nothing)
cv2.createTrackbar("WUS", "WTracking", 24, 255, nothing)
